...
def text_file_to_speech(source_path, output_path, tts_engine=None, *, alignment=None, reference_voice=None):
    ...
    *alignment* overrides the module-level ``_ALIGNMENT_ENABLED`` flag.
    ...
    for i, seg in enumerate(segments):
        ...
        seg_metas.append({
            ...
            "speaker_wav": reference_voice[seg['speaker']] if reference_voice else 'default.wav',
        })
